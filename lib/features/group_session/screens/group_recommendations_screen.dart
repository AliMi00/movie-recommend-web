...
class GroupRecommendationsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GroupRecommendationsScreen> createState() => _GroupRecommendationsScreenState();
}

class _GroupRecommendationsScreenState extends ConsumerState<GroupRecommendationsScreen> {
  ...
  void _onScroll() {
    if (_scrollController.position.pixels >= _scrollController.position.maxScrollExtent - 200) {
      ref.read(groupRecommendationsProvider(widget.code).notifier).loadRecommendations();
    }
  }
                            ...
                            slivers: [
                              ...
                              SliverList(
                                delegate: SliverChildBuilderDelegate(
                                        ...
                                        child: GlassContainer(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              child: Text(
                                                                movie.title,
                                                                style: AppTextStyles.movieSubtitle.copyWith(
                                                                  fontWeight: FontWeight.bold,
                                                                  fontSize: 17,
                                                                ),
                                                                maxLines: 2,
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    // Individual Scores
                                                    Column(
                                                      children: groupMovie.userScores.entries.map((entry) {
                                              ...
                                              if (groupMovie.groupReason.isNotEmpty) ...[
                                                const SizedBox(height: 12),
                                                Container(
                                  ...
                                  childCount: state.movies.length + (state.hasMore ? 1 : 0),
                                ),
                              ),
